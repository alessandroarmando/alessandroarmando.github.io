...
* the hex-encoded version is called the *fingerprint* of the key,
* the last (lower order) 16 characters are called the *long key ID*,
* the last (lower order) 8 characters are the short key ID.
